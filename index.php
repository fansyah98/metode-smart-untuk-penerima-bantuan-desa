...
<head>
    ...
    <title>SMART -  Bantuan Dana Desa</title>
    <!-- Favicon-->
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <div class="d-inline">
                <img src="assets/img/logo2.png" width="75" class="me-2">
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link bg-info pe-3 py-2 ms-2 rounded" href="masuk.php">Masuk</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">IMPLEMENTASI METODE SMARTH UNTUK MENENTUKAN MASYARAKAT TIDAK MAMPU DESA JADIMULYA KABUPATEN CIREBON
</p>
                    <a class="btn btn-info btn-xl" href="#rekomendasi">Lihat Rekomendasi</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="page-section" id="rekomendasi">
        <div class="container px-4 px-lg-5">
            ...
            ?>
            <p class="text-center mb-4">Berdasarkan hasil perhitungan Sistem Pendukung Keputusan dengan menggunakan metode SMART, didapatkan bahwa <span class="fw-bold">"<?= $data_rekom['nama_alternatif']; ?>"</span> adalah adalah masyarakat yang tidak mampu yang paling direkomendasikan untuk anda.</p>
            <div class="row gx-4 gx-lg-5">
                <div class="col-lg-12 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><i class="bi-gem fs-1 text-primary"></i></div>
                        <h3 class="h4 mb-2">Pengurutan Peringkat Rekomendasi Masyarakat Tidak Mampu</h3>
    ...
    <footer class="bg-light py-5">
        <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">Balai Pemerintah Desa Jadi Mulya</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
