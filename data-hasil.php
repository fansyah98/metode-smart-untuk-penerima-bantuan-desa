...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-info hstack gap-3">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="menu-utama.php">Desa Jadi Mulya</a>
        <!-- Sidebar Toggle-->
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            ?>
                            <p class="fs-5" style="text-align: justify;">Berdasarkan hasil perhitungan Sistem Pendukung Keputusan dengan menggunakan metode SMART, didapatkan bahwa <span class="fw-bold">"<?= $data_rekom['nama_alternatif']; ?>"</span> adalah masyarakat yang berhak mendapatkan bantuan yang paling direkomendasikan untuk anda.</p>
                            <div class="table-responsive" action="proses.php" method="post">
                                ...
                                <div class="text-center mb-3">
                                    <a href="print.php?validasi=sukses" class="btn btn-primary">Lihat Perhitungan </a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Balai Pengkajian Teknologi Pertanian</div>
                    </div>
                </div>
            </footer>
        </div>
