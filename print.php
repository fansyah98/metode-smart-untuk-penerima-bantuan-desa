		...
		<div class="row">
			<div class="col-sm-12 mt-3">
				<div class="d-flex">
					...
					<h3 class="text-center ms-2">Sistem Pendukung Keputusan Menentukan Penerima  bantuan desa  Menggunakan Metode Simple Multi Attribute Rating Technique (SMART)</h3>
				</div>
			</div>
			<div class="col-sm-12 mt-3">
				<?php
